...
<title>ĐĂNG NHẬP MBACKEND</title>
</head>
<body>
   <div id="mbackend-main-nav">
	...
	<div class="div-login-container">
		<form id="form-signup" class="form-signup" method="post" action="../user/signup">
			...
			<button id="btn-signup-submit" 	data-loading-text="Loading..." class="btn btn-lg btn-primary btn-block" type="button" >Đăng nhập</button>
