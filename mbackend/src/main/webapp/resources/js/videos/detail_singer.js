...
$(document)
		.ready(
				function() {
					...
					BaasBox.loadObject("MOVIES", SINGERID).done(
							function(res) {
									...
									function() {
										...
										BootstrapDialog
												.confirm(
														...
														function(result) {
															if (result) {
																location.href = "/videos/manager-singer";
															}
														});
									});
					...
					$("#mbackend-create-document").click(function() {
						...
						location.href = "../../videos/" + SINGERID + "/" + ID;
