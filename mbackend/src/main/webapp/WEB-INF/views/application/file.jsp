...
<link href="<c:url value="/resources/css/dataTables.bootstrap.css" />"
	rel="stylesheet">
<script src="<c:url value="/resources/js/application/file.js" />"></script>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-3">
				<div class="list-group">
					<a href="#" class="list-group-item disabled"> Menu </a> <a
						...
						class="list-group-item">Bảng dữ liệu</a> <a href="#"
						class="list-group-item active">File</a> 
			...
			<div class="col-xs-9">
				<div class="col-xs-12">
					<button id="mbackend-create-collection" style="margin-bottom: 10px"
						class="btn  btn-sm btn-primary">Tạo mới</button>
				</div>
				<div class="col-xs-12">
					<table id="mbackend-list-file"
